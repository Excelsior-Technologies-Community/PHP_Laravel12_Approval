...
Route::delete('/delete/{id}', [ApprovalController::class, 'destroy'])->name('approvals.destroy');
Route::get('/search-suggestions', [ApprovalController::class, 'searchSuggestions'])->name('approvals.suggestions');